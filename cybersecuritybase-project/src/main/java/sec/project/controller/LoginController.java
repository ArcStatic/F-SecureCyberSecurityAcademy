...
public class LoginController {
    ...
    public String loadForm(Model model, @RequestParam(required=true, value="name") String userName) {
        ...
        /**
         * OWASP A1: Injection - currently unimplemented
         * This section was supposed to allow native SQL queries to run using input from the 'name' variable of the URL
         * Would've allowed SQL queries to be executed using input with the 'name' variable of the URL
         * persistence.xml was causing problems, see the 'Persistence' branch of this project for attempted implementation
         * 
